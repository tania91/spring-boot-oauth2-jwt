...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
	 ...
	 private final ClientService clientService;
	  ...
	  public JWTAuthenticationFilter(UserRepository userRepository, String privateKey, AuthenticationManager authenticationManager, TokenRepository tokenRepository, TokenService tokenService, ClientService clientService) {
	  ...
	  public Authentication attemptAuthentication(HttpServletRequest request,
		  ...
		  UsernamePasswordAuthenticationToken authenticationToken = null;
			  ...
			  if(request.getParameter("grant_type").equals(Constants.REFRESH_TOKEN )){
			    ...
			    if (StringUtils.isEmpty(header) || !header.startsWith(Constants.TOKEN_PREFIX)) {
			    	...
			    	try {
						List<ClientEntity> client = clientService.find(client_id, client_secret);
						if(!client.isEmpty()) {
